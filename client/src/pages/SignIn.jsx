...
import { Video, Mail, Lock, Loader2, ArrowRight, Eye, EyeOff } from 'lucide-react'
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-purple-600 to-blue-700 items-center justify-center p-12">
        <div className="max-w-lg text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Continue conducting seamless technical interviews with AI-powered assistance.
          </p>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-left">
            <p className="text-purple-100 italic mb-4">
              "HireeFlow.ai has transformed how we conduct technical interviews. The AI questions are spot-on and the code editor is fantastic."
            </p>
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 bg-gradient-to-br from-purple-400 to-blue-400 rounded-full" />
              <div>
                <p className="text-white font-semibold">Sarah Chen</p>
                <p className="text-purple-200 text-sm">Engineering Manager, TechCorp</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="py-3 px-4 bg-slate-900 hover:bg-slate-800 border border-slate-700 rounded-xl text-white font-medium transition flex items-center justify-center gap-2">
